...
.container {
  ...
  background-color: #f7fafc; /* Match the background color from the screenshot */
  padding: 1rem; /* Add padding to prevent sticking to edges on small screens */
}

/* Ensure the inner container (max-w-3xl) doesn't stretch too much */
.max-w-3xl {
  width: 100%;
  max-width: 48rem; /* Match the width from the screenshot */
}
