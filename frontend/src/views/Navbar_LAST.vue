    ...
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
      <div class="relative flex h-16 items-center justify-between">
        ...
        <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
          <button v-if="route.path !== '/' && route.path !== '/admin' && route.path !== '/fileupload' && route.path !== '/admindashboard'" type="button" @click="handleItemClick('Log In')" class="relative rounded-md text-gray-900 hover:bg-gray-300 px-3 mr-1 py-2 text-sm font-medium cursor-pointer">
            User Login
          </button>
          <button v-if="route.path !== '/admin' && route.path !== '/register' &&route.path !== '/fileupload' && route.path !== '/admindashboard'" type="button" @click="handleItemClick('Admin Login')" class="relative rounded-md text-gray-900 hover:bg-gray-300 px-3 mr-1 py-2 text-sm font-medium cursor-pointer">
            Admin Login
          </button>
